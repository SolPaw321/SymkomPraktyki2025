...
from model.D2_5.geometry.misc.PATHS import AIRFOIL_MODEL_2D, AIRFOIL_MODEL_3D
from ansys.geometry.core.math import Point2D, Point3D, UnitVector3D, Vector3D, Plane
...
class ModelerController:
    ...
    def __extrude(self, component: Component,
                  ...
                  sketch: Sketch):
        """
        Extrude sketch basing on your model type (2D or 3D).
    ...
    def add_wall(self,
        ...
        # get elements (faces of edges based od model type) and element ids before subtraction
    ...
    def load_airfoils(self,
        ...
        This method also place your airfoil model into the circe of given radius.

        Args:
            file_name (str): file name of your model
        ...
        # get your model as component and add to components dictionary
        component = self._design.components[0]
        self._components["NACA"] = component

        # component.set_name = "NACA"  # available in 25R2

        # get your model as body and scale
        airfoil = component.bodies[0]
        airfoil.scale(100)  # 0.1

        # find the geometric center of your model and translate it to the coordinate system center
        ...
        # add copies of your model to the circle
